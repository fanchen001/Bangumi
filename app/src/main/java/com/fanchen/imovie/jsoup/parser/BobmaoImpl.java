...
public class BobmaoImpl implements IVideoMoreParser {
    ...
    private KankanwuImpl kankanwu = new KankanwuImpl(BobmaoService.class.getName(), false);
    ...
    public IPlayUrls playUrl(Retrofit retrofit, String baseUrl, String html) {
        ...
        try {
            int start = html.indexOf("var zanpiancms_player = {");
            if (start != -1) html = html.substring(start + 24);
