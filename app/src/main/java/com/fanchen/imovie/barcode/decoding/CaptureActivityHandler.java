...
package com.fanchen.imovie.barcode.decoding;
...
public final class CaptureActivityHandler extends Handler {
    ...
    public CaptureActivityHandler(CaptureFragment fragment, Vector<BarcodeFormat> decodeFormats,
        ...
        decodeThread = new DecodeThread(fragment, decodeFormats, characterSet,new ViewfinderView.ViewfinderResultPointCallback(viewfinderView));
        decodeThread.start();
        state = State.SUCCESS;
